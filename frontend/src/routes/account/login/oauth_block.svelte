...
{#if google_auth_enabled}
	<div class="flex items-center justify-center pt-4">
		<a
			...
			class="inline-flex w-fit p-1 rounded-lg border-2 border-base bg-surface text-base hover:bg-primary hover:text-white transition items-center"
		>
			Google Login
...
{#if github_auth_enabled}
	<div class="flex items-center w-full justify-center pt-4">
		<a
			...
			class="inline-flex w-fit p-1 rounded-lg border-2 border-base bg-surface text-base hover:bg-gray-900 hover:text-white transition group items-center"
		>
			GitHub Login

			<svg
				class="h-6 w-6 ml-4 fill-current transition"
				role="img"
				viewBox="0 0 24 24"
				xmlns="http://www.w3.org/2000/svg"
			>
...
{#if custom_oauth_name}
	<div class="flex items-center w-full justify-center pt-4">
		<a
			...
			class="inline-flex w-fit p-1 rounded-lg border-2 border-base bg-surface text-base hover:bg-primary hover:text-white transition group items-center"
		>
			OpenID Login
